...
export default function App() {
  ...
  const [formData, setFormData] = useState<{
    ...
    name: '', title: '', house: 'targaryen', isKing: false, isBastard: false, isNonCanon: false, isDragonRider: false, isDisputed: false, disputedParentageLore: '', dragonName: '', isGap: false, imageUrl: '', wikiLink: '',
    ...
    if (modalMode === 'edit') {
        ...
        setDatasets(prev => {
            ...
            const updatedHouse = {
                ...
                characters: currentHouse.characters.map(c => c.id === selectedCharId ? { 
                    ...
                    isKing: formData.isKing, isBastard: formData.isBastard, isNonCanon: formData.isNonCanon, isDragonRider: formData.isDragonRider, isDisputed: formData.isDisputed, disputedParentageLore: formData.disputedParentageLore, dragonName: formData.dragonName, isGap: formData.isGap,
        ...
        if (isLinkingExisting && linkCharId) {
             ...
             const newChar: Character = {
                    ...
                    generation: newGen, x: newX, house: 'targaryen', isKing: formData.isKing, isBastard: formData.isBastard, isNonCanon: formData.isNonCanon, isDragonRider: formData.isDragonRider, isDisputed: formData.isDisputed, disputedParentageLore: formData.disputedParentageLore, dragonName: formData.dragonName, isGap: formData.isGap,
                    imageUrl: formData.imageUrl, wikiLink: formData.wikiLink, artistName: formData.artistName, artistLink: formData.artistLink, birthYear: formData.birthYear, deathYear: formData.deathYear, lore: formData.lore, status: formData.status as CharacterStatus
             };
  ...
  const openModalWrapper = useCallback((mode: typeof modalMode, charId: string) => {
    ...
    if (mode === 'add-root') {
         setFormData({ name: '', title: '', house: activeTab, isKing: false, isBastard: false, isNonCanon: false, isDragonRider: false, isDisputed: false, disputedParentageLore: '', dragonName: '', isGap: false, imageUrl: '', wikiLink: '', birthYear: '', deathYear: '', lore: '', status: 'alive', newHouseName: '', newHouseColor: 'black', newHouseCustomColor: '', artistName: '', artistLink: '' });
         return;
    }
    ...
    if (mode === 'edit' && char) {
        setFormData({ 
            ...
            isKing: !!char.isKing, isBastard: !!char.isBastard, isNonCanon: !!char.isNonCanon, isDragonRider: !!char.isDragonRider, isDisputed: !!char.isDisputed, disputedParentageLore: char.disputedParentageLore || '', dragonName: char.dragonName || '', isGap: !!char.isGap,
